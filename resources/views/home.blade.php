            ...
            <section
                ...
                <div class="relative grid lg:grid-cols-2 gap-8 lg:gap-20 p-8 md:p-16 items-center">
                    ...
                    <div class="space-y-6 text-white animate-fade-in-up delay-200">
                        ...
                        <div class="flex flex-wrap items-center justify-between gap-4 pt-6 mt-6 border-t border-white/20">
                            <!-- Browse Button on Left -->
                            <a href="{{ route('projects.index') }}" class="inline-flex items-center px-5 py-2.5 bg-white/10 hover:bg-white/20 text-white text-sm font-medium rounded-lg backdrop-blur-sm border border-white/20 transition-colors duration-200 shadow-sm hover:shadow-lg">
                            ...
                            <div class="flex flex-wrap gap-3">
                                <a href="{{ route('login') }}" class="px-6 py-2.5 bg-white text-indigo-600 rounded-lg font-bold hover:bg-blue-50 shadow transition-all duration-200 text-sm">
                                    Login
                                </a>
                                <a href="{{ route('register') }}" class="px-6 py-2.5 bg-indigo-500/50 text-white border border-indigo-300 rounded-lg font-bold hover:bg-indigo-500 shadow transition-all duration-200 text-sm">
                                    Register
                                </a>
                            </div>
                        </div>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12 animate-fade-in-up delay-500">
                ...
                <div
                    ...
                    <div class="relative z-10">
                        ...
                        <p class="text-gray-600 text-sm leading-relaxed">
                            Anyone can use the search bar to check if their capstone idea has already been done by a previous group.
                        </p>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="relative z-10">
                        ...
                        <p class="text-gray-600 text-sm leading-relaxed">
                            Graduating students log in to upload their final capstone project and fill out the details about their system.
                        </p>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="relative z-10">
                        ...
                        <p class="text-gray-600 text-sm leading-relaxed">
                            Advisers look over the submitted projects to make sure everything is correct before they approve them for the library.
                        </p>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="relative z-10">
                        ...
                        <p class="text-gray-600 text-sm leading-relaxed">
                            Once approved, anyone can read the summary of the project. But you must be logged in to download the full files.
                        </p>
                    </div>
                </div>
            </div>
