<x-guest-layout>
    <form method="POST" action="{{ route('register') }}" class="space-y-1">
        ...
        <div>
            ...
            <div class="relative">
                ...
                <button type="button" onclick="togglePasswordVisibility('password')"
                    class="absolute inset-y-0 right-0 pr-4 flex items-center cursor-pointer z-10 text-slate-500 hover:text-slate-300 transition-colors">
        ...
        <div>
            ...
            <div class="relative">
                ...
                <button type="button" onclick="togglePasswordVisibility('password_confirmation')"
                    ...
                    <svg id="eyeIconPasswordConfirmation" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <button type="submit"
            ...
            class="w-full py-3.5 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-xl transition-all duration-200 shadow-lg shadow-indigo-900/30 hover:shadow-xl transform hover:-translate-y-0.5">
            Create Account
        </button>
