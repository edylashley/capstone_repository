            ...
            card.innerHTML = `
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="space-y-4">
                            <div>
                                <label class="block font-medium text-sm text-gray-700 dark:text-slate-300">Keywords <span class="text-gray-500 dark:text-slate-400 text-[10px] uppercase">(Optional)</span></label>
                                <input type="text" name="projects[${idx}][keywords]" placeholder="e.g. machine learning, web app" class="mt-1 block w-full rounded-xl border-gray-300 dark:border-slate-700 bg-white dark:bg-slate-800 text-gray-900 dark:text-white shadow-sm focus:border-blue-500 dark:focus:border-indigo-500 focus:ring-blue-500 dark:focus:ring-indigo-500 text-sm transition-colors">
                            </div>
                            <div>
