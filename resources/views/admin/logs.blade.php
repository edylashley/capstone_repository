                                            ...
                                            <p class="text-[14px] text-gray-700 dark:text-gray-300 font-bold leading-tight">
                                                @php
                                                    ...
                                                    $description = match($log->action) {
                                                        ...
                                                        'account_denied' => 'Denied registration request for ' . ($meta['name'] ?? 'Unknown User'),
                                                        ...
                                                        'submission_validation_failed' => 'Invalid Submission: A project upload was returned due to form errors (e.g., file too large).',
                                                        'submission_rejected_duplicate' => 'Duplicate Content: Submission for "' . ($meta['title'] ?? 'Unknown') . '" was returned due to identical content in the repository.',
