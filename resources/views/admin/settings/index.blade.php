    ...
    <div class="py-8">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
            ...
            <div class="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-2">
                <div>
                    <h2 class="font-black text-4xl text-gray-900 dark:text-white uppercase tracking-tighter leading-none">System Settings</h2>
                    <p class="text-[10px] text-blue-600 dark:text-indigo-400 uppercase tracking-[0.4em] font-black mt-3 opacity-80">General Website Configuration</p>
                </div>
            ...
            <div class="bg-white dark:bg-slate-900 border border-gray-200 dark:border-white/5 overflow-hidden shadow-sm sm:rounded-lg transition-colors">
                <div class="p-8 text-gray-900 dark:text-white border-b-4 border-blue-500 dark:border-indigo-500">
                    <h3 class="text-xl font-bold mb-6 text-blue-600 dark:text-indigo-400">Website Configuration</h3>
                    ...
                    <form action="{{ route('admin.settings.update') }}" method="POST" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <label for="repository_name" class="block text-sm font-bold text-gray-700 dark:text-slate-300 mb-1">
                                ...
                                <input type="text" id="repository_name" name="repository_name" 
                                    ...
                                    class="w-full rounded-md border-gray-300 dark:border-slate-700 bg-white dark:bg-slate-800 text-gray-900 dark:text-white shadow-sm focus:border-blue-500 dark:focus:border-indigo-500 focus:ring-blue-500 dark:focus:ring-indigo-500 transition-colors">
                                @error('repository_name') <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p> @enderror
                            </div>

                            <div>
                                <label for="academic_year" class="block text-sm font-bold text-gray-700 dark:text-slate-300 mb-1">
                        ...
                        <div class="mt-8 border-t border-gray-200 dark:border-slate-700 pt-8 transition-colors">
                            <h4 class="text-md font-bold text-gray-900 dark:text-white mb-4 border-l-4 border-emerald-500 pl-3">Upload Configurations</h4>
                            
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div>
                                    <label for="max_upload_size" class="block text-sm font-bold text-gray-700 dark:text-slate-300 mb-1">
                                ...
                                <div>
                                    <label for="max_attachment_size" class="block text-sm font-bold text-gray-700 dark:text-slate-300 mb-1">
                        ...
                        <!-- Submission Controls -->
                        <div class="mt-8 border-t border-gray-200 dark:border-slate-700 pt-8 transition-colors">
                            <h4 class="text-md font-bold text-gray-900 dark:text-white mb-4 border-l-4 border-blue-500 pl-3">Submission Controls</h4>
                            
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 bg-blue-50/50 dark:bg-slate-800/30 p-6 rounded-xl border border-blue-100 dark:border-slate-700">
                                ...
                                <div class="col-span-1 md:col-span-2 flex items-center gap-6 p-6 bg-white dark:bg-slate-900 rounded-lg shadow-sm border border-gray-200 dark:border-slate-700 transition-colors">
                                    ...
                                    <div>
                                        <label for="submissions_open" class="font-bold text-lg text-gray-900 dark:text-white cursor-pointer block">Accepting New Submissions</label>
                                ...
                                <div class="col-span-1 md:col-span-2">
                                    <label for="submission_deadline_date" class="block text-sm font-bold text-gray-900 dark:text-white mb-1">
                                        Strict Submission Deadline <span class="text-xs font-normal text-gray-500 dark:text-white ml-2">(Optional)</span>
                                    </label>
                                    <p class="text-xs text-gray-600 dark:text-white mb-4">If a date and time are set, the system will automatically lock and reject submissions past this exact moment.</p>
                                    
                                    <div class="flex flex-col md:flex-row gap-4 mb-2">
                                        <div class="flex-1 w-full">
                                            <label class="block text-[10px] uppercase font-black text-gray-600 dark:text-gray-400 mb-1 tracking-widest">Select Date</label>
                                            <div class="relative">
                                                <input type="date" id="submission_deadline_date" name="submission_deadline_date" 
                                                    ...
                                                    class="w-full rounded-md border-gray-300 dark:border-slate-700 bg-white dark:bg-slate-800 text-gray-900 dark:text-white shadow-sm focus:border-blue-500 dark:focus:border-indigo-500 focus:ring-blue-500 dark:focus:ring-indigo-500 transition-colors pl-10">
                                        ...
                                        <div class="flex-1 w-full">
                                            <label class="block text-[10px] uppercase font-black text-gray-600 dark:text-gray-400 mb-1 tracking-widest">Select Cut-off Time</label>
                                            <div class="relative">
                                                <input type="time" id="submission_deadline_time" name="submission_deadline_time" 
                                                    ...
                                                    class="w-full rounded-md border-gray-300 dark:border-slate-700 bg-white dark:bg-slate-800 text-gray-900 dark:text-white shadow-sm focus:border-blue-500 dark:focus:border-indigo-500 focus:ring-blue-500 dark:focus:ring-indigo-500 transition-colors pl-10">
                                                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-gray-500 dark:text-white">
                                    ...
                                    <div class="flex justify-center">
                                        <button type="button" 
                                            ...
                                            class="text-[10px] font-bold text-gray-500 dark:text-gray-200 hover:text-red-600 transition-colors uppercase tracking-widest bg-transparent border-0 p-0 cursor-pointer">
                                            Clear
                                        </button>
                                    </div>
                        ...
                        <div class="mt-8 border-t border-gray-200 dark:border-slate-700 pt-8 transition-colors">
                            <h4 class="text-md font-bold text-gray-900 dark:text-white mb-4 border-l-4 border-amber-500 pl-3">Activity Log Settings</h4>
                            
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label for="log_retention_days" class="block text-sm font-bold text-gray-700 dark:text-slate-300 mb-1">
                                ...
                                <div class="flex items-end">
                                    <div class="p-4 bg-amber-50 dark:bg-amber-900/10 rounded-lg border border-amber-100 dark:border-amber-800/50 w-full">
                                        ...
                                        <p class="text-xs text-gray-600 dark:text-gray-400">Higher retention (90+ days) keeps logs longer for review, while lower retention (30 days) saves database storage.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- Maintenance Settings -->
                         <div class="mt-8 border-t border-gray-200 dark:border-slate-700 pt-8 transition-colors">
                            <h4 class="text-md font-bold text-gray-900 dark:text-white mb-4 border-l-4 border-rose-500 pl-3">Danger Zone</h4>
                            
                            <div class="bg-rose-50 dark:bg-rose-900/10 p-4 rounded-lg border border-rose-200 dark:border-rose-800/50 flex items-start gap-3 transition-colors">
                                <div class="mt-1">
                                ...
                                <div class="ml-2 text-sm">
                                    ...
                                    <p class="text-rose-600 dark:text-rose-300/80 mt-1">
                        ...
                        <div class="mt-8 flex justify-end">
                            <button type="submit" class="bg-blue-600 dark:bg-indigo-600 hover:bg-blue-700 dark:hover:bg-indigo-700 text-white font-bold py-3 px-8 rounded-xl shadow-lg transition-all flex items-center gap-2 uppercase tracking-widest text-[10px]">
