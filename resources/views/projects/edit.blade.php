<x-app-layout>
    ...
    <div id="loading-overlay"
        ...
        <div class="bg-slate-900 rounded-[2.5rem] shadow-2xl p-12 flex flex-col items-center gap-8 max-w-sm w-full mx-4 border border-white/10">
            ...
            <p class="text-[9px] text-slate-600 text-center uppercase tracking-tighter leading-tight">Institutional resubmission protocol.<br>Finalizing metadata verification.</p>
        </div>
    </div>
