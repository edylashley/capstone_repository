<footer class="text-white py-6 bg-slate-950">
    <div class="max-w-7xl mx-auto px-6">
        <div class="flex flex-col md:flex-row justify-between items-center text-center md:text-left gap-4">
            <div class="flex-1">
                ...
                <p class="text-[10px] text-slate-400 font-bold uppercase mt-1">Institutional Research Library</p>
            </div>

            <div class="flex-1 flex flex-col items-center">
                <div class="text-xs font-black uppercase tracking-widest">Negros Oriental State University</div>
                <div class="text-[10px] text-slate-400 mt-1 uppercase font-bold">Kagawasan Avenue, Dumaguete City,
                    Negros Oriental
                </div>
            </div>
