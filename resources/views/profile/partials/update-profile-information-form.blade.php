        ...
        <div class="relative group">
            ...
            <div class="relative">
                ...
                <input id="student_id" name="student_id" type="text" 
                    class="block w-full pl-11 pr-4 py-3.5 bg-gray-100 dark:bg-slate-950/50 border border-gray-200 dark:border-white/5 rounded-2xl text-gray-500 dark:text-slate-400 text-sm font-bold cursor-not-allowed shadow-sm dark:shadow-inner" 
        ...
        <div class="relative group">
            ...
            <div class="relative">
                ...
                <select id="program" name="program" 
                    class="block w-full pl-11 pr-4 py-3.5 bg-gray-50 dark:bg-slate-950/50 border border-gray-200 dark:border-white/5 rounded-2xl text-gray-900 dark:text-white text-sm font-bold focus:ring-2 focus:ring-blue-500/20 dark:focus:ring-indigo-500/20 focus:border-blue-500/50 dark:focus:border-indigo-500/50 transition-all appearance-none shadow-sm dark:shadow-inner">
